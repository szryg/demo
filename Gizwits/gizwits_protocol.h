...
* @{
*/
#define PRODUCT_KEY "d693dc0d7c6047a881f9c991ee7fbb28"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "6b1a2d2b455d44ab990929824bb54f52"
...
* @{
*/
#define Switch_Total_BYTEOFFSET                    0
#define Switch_Total_BITOFFSET                     0
#define Switch_Total_LEN                           1
#define Switch_Node_BYTEOFFSET                    0
#define Switch_Node_BITOFFSET                     1
#define Switch_Node_LEN                           1
#define Switch_Custody_BYTEOFFSET                    0
#define Switch_Custody_BITOFFSET                     2
#define Switch_Custody_LEN                           1
#define Clean_Procedures_BYTEOFFSET                    0
#define Clean_Procedures_BITOFFSET                     3
#define Clean_Procedures_LEN                           3
#define Custody_BYTEOFFSET                    0
#define Custody_BITOFFSET                     6
#define Custody_LEN                           2

#define Timing_Order_On_RATIO                         1
#define Timing_Order_On_ADDITION                      0
#define Timing_Order_On_MIN                           0
#define Timing_Order_On_MAX                           1440
#define Timing_Off_RATIO                         1
#define Timing_Off_ADDITION                      0
#define Timing_Off_MIN                           0
#define Timing_Off_MAX                           1440
/**@} */
...
typedef enum
{
    Clean_Procedures_VALUE0 = 0,//智能
    Clean_Procedures_VALUE1 = 1,//标准
    Clean_Procedures_VALUE2 = 2,//节能
    Clean_Procedures_VALUE3 = 3,//果蔬
    Clean_Procedures_VALUE4 = 4,//腔体清洁
    Clean_Procedures_VALUE_MAX,
} Clean_Procedures_ENUM_T;
typedef enum
{
    Custody_VALUE0 = 0,//热风烘干
    Custody_VALUE1 = 1,//紫外杀菌
    Custody_VALUE2 = 2,//混合模式
    Custody_VALUE_MAX,
} Custody_ENUM_T;
...
typedef enum
{
  ...
  EVENT_Switch_Total,
  EVENT_Switch_Node,
  EVENT_Switch_Custody,
  EVENT_Clean_Procedures,
  EVENT_Custody,
  EVENT_Timing_Order_On,
  EVENT_Timing_Off,
...
typedef struct {
  bool valueSwitch_Total;
  bool valueSwitch_Node;
  bool valueSwitch_Custody;
  uint32_t valueClean_Procedures;
  uint32_t valueCustody;
  uint32_t valueTiming_Order_On;
  uint32_t valueTiming_Off;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
  uint8_t flagSwitch_Total:1;
  uint8_t flagSwitch_Node:1;
  uint8_t flagSwitch_Custody:1;
  uint8_t flagClean_Procedures:1;
  uint8_t flagCustody:1;
  uint8_t flagTiming_Order_On:1;
  uint8_t flagTiming_Off:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint16_t valueTiming_Order_On;
  uint16_t valueTiming_Off;
} attrVals_t;
